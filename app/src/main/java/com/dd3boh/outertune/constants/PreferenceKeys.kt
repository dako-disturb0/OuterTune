...
val PlayerTimelineTypeKey = stringPreferencesKey("playerTimelineType")
val PlayerTimelineSizeKey = intPreferencesKey("playerTimelineSize")
val PlayerThumbnailSizeKey = floatPreferencesKey("playerThumbnailSize")
val PlayerThumbnailRoundnessKey = intPreferencesKey("playerThumbnailRoundness")
val PlayerThumbnailAutoCropKey = booleanPreferencesKey("playerThumbnailAutoCrop")
val ShowInlineInfoKey = booleanPreferencesKey("showInlineInfo")
