...
import app.dkdstrb.excitedtune.constants.LyricClickable
import app.dkdstrb.excitedtune.constants.LyricFontSizeKey
import app.dkdstrb.excitedtune.constants.LyricKaraokeEnable
import app.dkdstrb.excitedtune.constants.LyricSourcePrefKey
import app.dkdstrb.excitedtune.constants.LyricTrimKey
import app.dkdstrb.excitedtune.constants.LyricUpdateSpeed
import app.dkdstrb.excitedtune.constants.LyricsPosition
import app.dkdstrb.excitedtune.constants.LyricsProviderOrderKey
import app.dkdstrb.excitedtune.constants.LyricsTextPositionKey
import app.dkdstrb.excitedtune.constants.MiniPlayerLyricModeKey
import app.dkdstrb.excitedtune.constants.MultilineLrcKey
import app.dkdstrb.excitedtune.constants.Speed
...
import app.dkdstrb.excitedtune.viewmodels.PaxsenixStatsViewModel
...
fun ColumnScope.LyricFormatFrag() {
    ...
    val (showLyricInMiniPlayer, onShowLyricInMiniPlayerChange) = rememberPreference(
        app.dkdstrb.excitedtune.constants.ShowLyricInMiniPlayerKey,
        defaultValue = true
    )
...
fun ColumnScope.LyricAdvancedFrag() {
    ...
    val (preloadKaraokeLyrics, onPreloadKaraokeLyricsChange) = rememberPreference(
        app.dkdstrb.excitedtune.constants.PreloadKaraokeLyricsKey,
        defaultValue = false
    )
