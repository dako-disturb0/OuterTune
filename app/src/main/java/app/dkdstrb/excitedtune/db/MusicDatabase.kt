package app.dkdstrb.excitedtune.db
...
import app.dkdstrb.excitedtune.db.MusicDatabase.Companion.MUSIC_DATABASE_VERSION
import app.dkdstrb.excitedtune.db.entities.AlbumArtistMap
import app.dkdstrb.excitedtune.db.entities.AlbumEntity
import app.dkdstrb.excitedtune.db.entities.ArtistEntity
import app.dkdstrb.excitedtune.db.entities.Event
import app.dkdstrb.excitedtune.db.entities.FormatEntity
import app.dkdstrb.excitedtune.db.entities.GenreEntity
import app.dkdstrb.excitedtune.db.entities.LyricsEntity
import app.dkdstrb.excitedtune.db.entities.PlayCountEntity
import app.dkdstrb.excitedtune.db.entities.PlaylistEntity
import app.dkdstrb.excitedtune.db.entities.PlaylistEntity.Companion.generatePlaylistId
import app.dkdstrb.excitedtune.db.entities.PlaylistSongMap
import app.dkdstrb.excitedtune.db.entities.PlaylistSongMapPreview
import app.dkdstrb.excitedtune.db.entities.QueueEntity
import app.dkdstrb.excitedtune.db.entities.QueueSongMap
import app.dkdstrb.excitedtune.db.entities.RecentActivityEntity
import app.dkdstrb.excitedtune.db.entities.RelatedSongMap
import app.dkdstrb.excitedtune.db.entities.SearchHistory
import app.dkdstrb.excitedtune.db.entities.SongAlbumMap
import app.dkdstrb.excitedtune.db.entities.SongArtistMap
import app.dkdstrb.excitedtune.db.entities.SongEntity
import app.dkdstrb.excitedtune.db.entities.SongGenreMap
import app.dkdstrb.excitedtune.db.entities.SortedSongAlbumMap
import app.dkdstrb.excitedtune.db.entities.SortedSongArtistMap
import app.dkdstrb.excitedtune.extensions.toSQLiteQuery
...
abstract class InternalDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun newInstance(context: Context): MusicDatabase {
            ...
            app.dkdstrb.excitedtune.Leafx.recoverDatabase(context)
