...
import app.dkdstrb.excitedtune.constants.MediaSessionConstants
...
import app.dkdstrb.excitedtune.extensions.toggleShuffleMode
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun app.dkdstrb.excitedtune.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
