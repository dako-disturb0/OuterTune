...
import app.dkdstrb.excitedtune.db.entities.LyricsEntity.Companion.LYRICS_NOT_FOUND
...
class LyricsHelper @Inject constructor(
    ...
    suspend fun getLyrics(
        ...
        val preloadKaraoke = context.dataStore.get(app.dkdstrb.excitedtune.constants.PreloadKaraokeLyricsKey, defaultValue = false)
